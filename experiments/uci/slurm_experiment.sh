...
echo "python run_uci.py --dataset_name $DATASET --dataset_nsplit $NUM_SPLIT --ll robust --modelSVGP $Model --Ptype $TYPE --scaling $Standard_N --nGPU $GPU_N $extra_conf";
python run_uci.py --dataset_name $DATASET --dataset_nsplit $NUM_SPLIT --ll robust --modelSVGP $Model --Ptype $TYPE --scaling $Standard_N --nGPU $GPU_N $extra_conf

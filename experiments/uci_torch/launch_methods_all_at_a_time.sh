...
do
    ...
    python run_uci.py --dataset_name $DATASET --dataset_nsplit $NUM_SPLIT --modelSVGP $Model --Ptype $TYPE --scaling $Standard_N --ll $ll --nGPU $GPU_N --nip $nip --nhn1 5 --nhl1 1 --rdropout 0.0 &
    done
done
